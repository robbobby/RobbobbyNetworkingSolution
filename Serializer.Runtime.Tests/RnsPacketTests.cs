...
namespace Serializer.Runtime.Tests
{
    ...
    // These will be generated by the Serializer.Generator, but for now we'll create stub classes
    ...
    public partial class TestPacket
    {
        ...
        public static bool TryRead(ReadOnlySpan<byte> buffer, out TestPacket packet, out int bytesRead)
        {
            // Stub implementation - will be generated
    ...
    public partial class TestFieldPacket
    {
        ...
        public static bool TryRead(ReadOnlySpan<byte> buffer, out TestFieldPacket packet, out int bytesRead)
        {
            // Stub implementation - will be generated
            packet = new TestFieldPacket();
            bytesRead = 0;
            return false;
        }
    }
    ...
    public partial class TestFieldPacket2
    {
        ...
        public static bool TryRead(ReadOnlySpan<byte> buffer, out TestFieldPacket2 packet, out int bytesRead)
        {
            // Stub implementation - will be generated
            packet = new TestFieldPacket2();
            bytesRead = 0;
            return false;
        }
    }
